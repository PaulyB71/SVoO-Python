...
for i in range(nocli):
    ...
    print(pni.text)
    pavid = pson[i].find("./Person/Client/Host")
    print(pavid.text)
    pavid = pson[i].find("./Person/Client/ClientId")
    print(pavid.text)
    pavid = pson[i].find("./Person/Contract/Code")
    print(pavid.text)
    pavid = pson[i].find("./Person/Contract/Name")
    print(pavid.text)
    pavid = pson[i].find("./Person/Contract/Product")
    print(pavid.text)
    pavid = pson[i].find("./Person/Contract/Role")
    print(pavid.text)